...
- failed_predictions_r_c5c2a1_costly_commitment_a171c2_index
...
show_ads: true
description: Giving away possessions, moving cities, or going public can make a failed UFO prediction harder for believers to abandon.
hero_summary: Giving away possessions, moving cities, or going public can make a failed UFO prediction harder for believers to abandon.
layout: default
permalink: /commitment/
sidebar_expanded_urls:
- /failed-predictions/
nav_short_title: Commitment
title: Why Costly Belief Changes the Aftermath
title_full: Why Costly Belief Changes the Aftermath
display_title_short: Commitment
display_title: Commitment
heading_title: Why Costly Belief Changes the Aftermath
page_heading_title: Why Costly Belief Changes the Aftermath
source_count: 87
infographic_count: 3
planned_sections:
...
<img src="{{ "/assets/images/failed_predictions_r_c5c2a1_costly_commitment_a171c2-Illustration-3-dark.svg" | relative_url }}" alt="Commitment illustration 3" data-theme-src-dark="{{ "/assets/images/failed_predictions_r_c5c2a1_costly_commitment_a171c2-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/failed_predictions_r_c5c2a1_costly_commitment_a171c2-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Explores why people commit deeply to ideological causes.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Examines commitment, influence, and exit from high-control groups.</p>
        <div class="fr-book-actions">
