...
- failed_predictions_r_c5c2a1_leader_recantation_816aba_index
...
show_ads: true
description: Chen Tao and Martin's group show that leaders and followers may not explain failure in the same way or at the same speed.
hero_summary: Chen Tao and Martin's group show that leaders and followers may not explain failure in the same way or at the same speed.
layout: default
permalink: /leaders/
sidebar_expanded_urls:
- /failed-predictions/
nav_short_title: Leaders
title: What Happens When the Leader Backs Down
title_full: What Happens When the Leader Backs Down
display_title_short: Leaders
display_title: Leaders
heading_title: What Happens When the Leader Backs Down
page_heading_title: What Happens When the Leader Backs Down
source_count: 72
infographic_count: 3
planned_sections:
...
image: /assets/images/failed_predictions_r_c5c2a1_leader_recantation_816aba-overview-social.jpg
---
...
A failed UFO prediction usually has a visible public moment: the spacecraft does not land, the television message does not appear, the rescue does not come, or the world does not end. The leader may then face reporters, police, relatives, defectors and disappointed believers. That pressure encourages a recognisable form of [partial recantation]({{ 'partial-retreat/' | relative_url }}): the leader concedes the dated claim failed without necessarily abandoning the whole religious or cosmic framework that produced it.
...
<img src="{{ "/assets/images/failed_predictions_r_c5c2a1_leader_recantation_816aba-Illustration-3-dark.svg" | relative_url }}" alt="Leaders illustration 3" data-theme-src-dark="{{ "/assets/images/failed_predictions_r_c5c2a1_leader_recantation_816aba-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/failed_predictions_r_c5c2a1_leader_recantation_816aba-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Useful for understanding follower commitment beyond leaders.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Explores group dynamics when authority shifts.</p>
        <div class="fr-book-actions">
