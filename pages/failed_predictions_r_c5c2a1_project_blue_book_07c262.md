...
- failed_predictions_r_c5c2a1_project_blue_book_07c262_index
...
show_ads: true
description: Project Blue Book did not adjudicate every prophecy, but its findings shape the evidential backdrop for failed UFO predictions.
hero_summary: Project Blue Book did not adjudicate every prophecy, but its findings shape the evidential backdrop for failed UFO predictions.
layout: default
permalink: /blue-book/
sidebar_expanded_urls:
- /failed-predictions/
nav_short_title: Blue Book
title: Project Blue Book and the Alien Evidence Gap
title_full: Project Blue Book and the Alien Evidence Gap
display_title_short: Blue Book
display_title: Blue Book
heading_title: Project Blue Book and the Alien Evidence Gap
page_heading_title: Project Blue Book and the Alien Evidence Gap
source_count: 102
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: When UFO Messages Come by Telepathy
header:
  og_image: /assets/images/failed_predictions_r_c5c2a1_project_blue_book_07c262-overview-social.jpg
  preview_image: /assets/images/failed_predictions_r_c5c2a1_project_blue_book_07c262-overview.webp
image: /assets/images/failed_predictions_r_c5c2a1_project_blue_book_07c262-overview-social.jpg
---
...
This same distinction applies to later UFO-related prophecies and contact expectations. Claims of imminent landings, alien rescue, [disclosure]({{ 'disclosure/' | relative_url }}), cosmic evacuation or world transformation are not refuted by Blue Book case by case. They are assessed by a simpler standard: did the promised event occur, and is there independent evidence for the alien agency claimed? Blue Book’s answer to the second question was negative for the cases it investigated.
