...
show_ads: true
description: Some UFO prophecies promise both doom and prevention, letting believers explain failure as mercy rather than error.
hero_summary: Some UFO prophecies promise both doom and prevention, letting believers explain failure as mercy rather than error.
layout: default
...
title: When UFO Doom Is Said to Be Averted
title_full: When UFO Doom Is Said to Be Averted
display_title_short: Averted Doom
display_title: Averted Doom
heading_title: When UFO Doom Is Said to Be Averted
page_heading_title: When UFO Doom Is Said to Be Averted
source_count: 31
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Why Chen Tao's Garland Prophecy Failed in Public
header:
  og_image: /assets/images/failed_predictions_r_c5c2a1_ufo_rescue_predictio_e233fa_avertive_ufo_apocaly_1fe4c9-Illustration-1-social.jpg
  preview_image: /assets/images/failed_predictions_r_c5c2a1_ufo_rescue_predictio_e233fa_avertive_ufo_apocaly_1fe4c9-Illustration-1.webp
image: /assets/images/failed_predictions_r_c5c2a1_ufo_rescue_predictio_e233fa_avertive_ufo_apocaly_1fe4c9-Illustration-1-social.jpg
---
...
<img src="{{ "/assets/images/failed_predictions_r_c5c2a1_ufo_rescue_predictio_e233fa_avertive_ufo_apocaly_1fe4c9-Illustration-3-dark.svg" | relative_url }}" alt="Averted Doom illustration 3" data-theme-src-dark="{{ "/assets/images/failed_predictions_r_c5c2a1_ufo_rescue_predictio_e233fa_avertive_ufo_apocaly_1fe4c9-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/failed_predictions_r_c5c2a1_ufo_rescue_predictio_e233fa_avertive_ufo_apocaly_1fe4c9-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
1. **A warning arrives** through contactees, channelled messages, extraterrestrial communications, or prophetic [leaders]({{ 'leaders/' | relative_url }}).
2. **A catastrophe is predicted**, often involving war, environmental collapse, pole shifts, flooding, or planetary purification.
3. **Believers are given a role** in preventing the disaster through spiritual activity or consciousness-raising.
...
<img src="{{ "/assets/images/failed_predictions_r_c5c2a1_ufo_rescue_predictio_e233fa_avertive_ufo_apocaly_1fe4c9-Illustration-2-dark.svg" | relative_url }}" alt="Averted Doom illustration 2" data-theme-src-dark="{{ "/assets/images/failed_predictions_r_c5c2a1_ufo_rescue_predictio_e233fa_avertive_ufo_apocaly_1fe4c9-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/failed_predictions_r_c5c2a1_ufo_rescue_predictio_e233fa_avertive_ufo_apocaly_1fe4c9-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
4. **The catastrophe fails to occur**, allowing believers to claim that the warning succeeded because enough corrective action was taken. [Academia+2ResearchGate](https://www.academia.edu/34925335/Avertive_Apocalypticism)
...
* Moral purification and personal transformation. [Academia](https://www.academia.edu/34925335/Avertive_Apocalypticism)
...
Scholars note that many New Age and UFO-related movements place extraordinary emphasis on consciousness itself as a causal force. In these settings, averting disaster becomes difficult to falsify because there is no observable alternative timeline against which claims can be tested. [Academia](https://www.academia.edu/34925335/Avertive_Apocalypticism)

## The Seekers and the Claim That the World Was Saved

The most famous UFO prophecy failure in modern scholarship involved [Dorothy Martin]({{ 'dorothy-martin/' | relative_url }})'s group, later known through *When Prophecy Fails*. Martin's followers expected a devastating flood and believed spacecraft from the planet Clarion would rescue the faithful before destruction arrived. The flood never came, and the rescue craft never appeared. [Wikipedia](https://en.wikipedia.org/wiki/When_Prophecy_Fails)

What makes the case particularly relevant to avertive [apocalypse]({{ 'apocalypse/' | relative_url }}) is the explanation that emerged after the deadline passed. According to messages received within the group, divine forces had spared the world because the believers' faith and spiritual efforts had generated sufficient light and goodness. In effect, the prophecy was reinterpreted as a successful prevention of catastrophe. [Wikipedia](https://en.wikipedia.org/wiki/When_Prophecy_Fails)
...
This interpretation transformed a seemingly decisive failure into a form of spiritual victory. Whether or not later debates about the group's reactions alter details of the classic account, the episode remains one of the clearest illustrations of avertive reasoning in a UFO rescue setting. [Wikipedia+2ResearchGate](https://en.wikipedia.org/wiki/When_Prophecy_Fails)

## UFO Saviours as Planetary Guardians

Avertive thinking appears repeatedly in [UFO religions]({{ 'ufo-religion/' | relative_url }}) because extraterrestrials are often portrayed as morally advanced beings concerned with humanity's future. Rather than merely evacuating a [chosen few]({{ 'chosen-few/' | relative_url }}), they are said to work toward preventing catastrophe altogether. [ojs.zrc-sazu.si](https://ojs.zrc-sazu.si/traditiones/article/download/10542/9702/36031)
...
Avertive apocalypse blurs the distinction between a fulfilled prophecy and a failed one. In ordinary forecasting, a prediction is judged by whether the expected event occurs. In avertive systems, however, the non-occurrence of the event may itself be treated as proof that the prophecy achieved its purpose. [OUP Academic](https://academic.oup.com/edited-volume/34365/chapter/327331833?login=false)
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Examines UFO-based religious beliefs, prophetic claims, and the social dynamics surrounding extraterrestrial messages.</p>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Helps explain how apocalyptic groups adapt to changing outcomes and reinterpret expectations.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Provides historical context for apocalyptic expectations, salvation movements, and recurring end-times narratives.</p>
        <div class="fr-book-actions">
